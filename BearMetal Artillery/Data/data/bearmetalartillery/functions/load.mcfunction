scoreboard objectives add bma.vel_x dummy
...
scoreboard objectives add bma.target_id dummy
scoreboard players set #id bma.target_id 1

scoreboard objectives add bma.cooldown dummy
